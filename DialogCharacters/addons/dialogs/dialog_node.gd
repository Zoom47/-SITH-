extends Control
class_name DialogNode, "res://DialogCharacters/addons/dialogs/icon.svg"

var input_next = 'interact'
var dialog_index = 0
var finished = false
...
export(Resource) var dialog_resource = load("res://DialogCharacters/addons/dialogs/Resources/DefaultDialogResource.tres")
export(Array, Resource) var dialog_characters

onready var Portrait = load("res://DialogCharacters/addons/dialogs/Nodes/Portrait.tscn")
var dialog_script = [
	#{
	#	'fade-in': 2
	#},
	{
		'background': "res://DialogCharacters/addons/dialogs/Images/background/placeholder-2.png"
	},
	{
		'character': 'Iteb',
		'position': 'center',
	...
	},
	{
		'character': 'Iteb',
		'position': 'center',
		'text': '[shake]Is everything okay?[/shake]'
	},
	{
		'character': 'Zas',
